...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(ltwhome.gif);
...
<body>
    ...
    <!-- Slideshow container -->
    <div class="slideshow-container" style="display:flex" style="width: 1000px;">
        <div class="mySlides fade">
            <a href="Join.php">
                <img src="LOGIN.gif" style="width: 350px; margin: 100px;">
            </a>
        </div>
        <div class="mySlides fade">
            <a href="games.php">
                <img src="hostgameaa.gif" style="width: 350px; margin: 100px;">
            </a>
    </div>
</body>
</html>
